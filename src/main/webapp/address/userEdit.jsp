	...
	<div class="container">
		<form name="login" class="form-horizontal off-sm-2" action="<c:url value="/AddressUpdateAction.do"/>" method="post">
			<div class="form-group row">
				...
				<div class="col-sm-3">
					<input type="text" name="userId" class="form-control" readonly="readonly" value="${address.userid}">
				</div>
			</div>
			<div class="form-group row">
			...
			<div class="form-group row">
				<div class="offset-sm-2 col-sm-10">
					...
					<a href="AddressViewAction.do?userId=${address.userid}" class="btn btn-danger">취소</a>
				</div>
			</div>
		</form>
	</div>
