...
<script type="text/javascript" src="./resources/js/checkCreater.js"></script>
<meta charset="UTF-8">
<title>앙케이트 관리</title>
...
<body>
	...
	<div class="container">
		<form name="createGroup" class="form-horizontal off-sm-2" action="<c:url value="/EnqueteGroupUpdateAction.do"/>" method="post">
			...
			<div class="form-group row">
				<div class="offset-sm-2 col-sm-10">
					...
					<a href="<c:url value="/EnqueteGroupViewAction.do?groupId=${group.groupId}"/>" class="btn btn-danger">취소</a>
				</div>
			</div>
		</form>
	</div>
